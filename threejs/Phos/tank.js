...
function f_vec2() // THREE.Vector2
{ var S = window.S;
  var Y = S.pop();
  var X = S.pop();
  S.push( new THREE.Vector2( X, Y ) ); }

function f_vec3() // THREE.Vector3
{ var S = window.S;
  var Z = S.pop();
  var Y = S.pop();
  var X = S.pop();
...
export { f_tank, f_target, f_curve, f_geom, f_vec2, f_material, f_vec3, f_buffgeom, f_line, f_sc_add };
// window.tank = main;

/*
m = new Phos()
m.F("a: -10 0 0 vec3: ap: 0 10 0 vec3: ap: 10 0 0 vec3: ap:")
m.F("buffgeom:")
S.push( { color: 0x00ffff } ); m.F("material:")
m.F("swap: line: sc_add:")
// m.F("line: sc_add:")
*/
